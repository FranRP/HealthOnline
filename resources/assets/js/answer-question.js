      ...
      if(answerValue != ""){
        $.ajax({
          ...
          success: function (data) {
              ...
              $("#answer-"+data).slideUp();
              $(".alert-fallo-answer-edit").fadeOut();

          },
          error: function (data) {
              $('.alert-fallo-answer-edit').html("Ha ocurrido algún error");
              $('.alert-fallo-answer-edit').fadeIn();
              console.log('Error: No tienes permiso para realizar esta operación, no manipules el html.');
          }
        });

      } else {
        $('.alert-fallo-answer-edit').html("No puedes dejar el cuerpo de la pregunta vacío");
        $('.alert-fallo-answer-edit').fadeIn();
      }
